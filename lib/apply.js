exports.Apply = function(databaseUrl) {
  ...
  function root(req, res, next) {
    var body = '<html>Welcome to the Apply application.<br/>';
    body = body + '<li>A JSON descriptor of the API can be found at: <a href="/api">/api</a></li>';
    body = body + '<li>All urls given in the descriptor are relative to the URL of THIS page</li></html>';
    res.writeHead(200, {
